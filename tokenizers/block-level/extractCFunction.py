...
#    libclangPath = r'/usr/lib/llvm-3.8/lib/libclang-3.8.so.1'
...
#        print("install path")
    ...
    nodes = itertools.chain(tree.filter(clang.tree.ConstructorDeclaration),
                            tree.filter(clang.tree.MethodDeclaration))
